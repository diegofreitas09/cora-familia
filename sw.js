const C='cora-familia-v39';
const A=['./','./index.html','./app.css','./app.js','./auth.js','./config.js','./data.js','./cora-gestao-sync-v27.js','./orcamento-primeira-fix-v29.js','./orcamentos-registro-v30.js','./orcamento-verificacao-v35.js','./pdf-unificado-v37.js','./orcamento-save-v37.js','./manifest.webmanifest','./logo-escola.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./fachada-cora-familia.jpg'];
...
self.addEventListener('fetch',e=>{
 ...
 if(url.origin===self.location.origin&&(url.pathname.endsWith('/cora-familia/')||url.pathname.endsWith('/cora-familia/index.html'))){
  e.respondWith(fetch(e.request,{cache:'no-store'}).then(async r=>{let html=await r.text();
   ...
   html=html.replace('</body>',"<script src='pdf-unificado-v37.js?v=2'></script><script src='orcamento-save-v37.js?v=2'></script></body>");
